<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="work1.login" %>
...
<asp:TextBox ID="username" runat="server" CssClass="inputField" placeholder="Username"></asp:TextBox>
            </div>
    ...
    <div class="inputContainer">
        ...
        <asp:TextBox ID="password" runat="server" CssClass="inputField" TextMode="Password" placeholder="Password"></asp:TextBox>
    </div>
